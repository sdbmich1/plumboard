...
ActiveRecord::Schema.define(version: 20160311211603) do
  ...
  add_index "pixi_payments", ["pixi_id", "transaction_id", "invoice_id"], name: "index_pixi_payments_on_pixi_id_and_transaction_id_and_invoice_id", using: :btree
