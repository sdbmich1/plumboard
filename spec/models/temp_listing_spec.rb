...
describe "date validations" do
    ...
    describe '.event_type' do
        before do
            ...
            @temp_listing1 = FactoryGirl.create(:temp_listing)
            @temp_listing1.category_id = 'event'
            @temp_listing1.event_type_code = 'party'
            
        end
        
        it "should be an event" do
            !(@temp_listing1.event?.nil?)
        end
        
        it "should respond to .event_type" do
            @temp_listing1.event_type == 'party'
        end
        
        it "etype should respond to temp_listings.first" do
            !(@etype.temp_listings.first.nil?)
        end
